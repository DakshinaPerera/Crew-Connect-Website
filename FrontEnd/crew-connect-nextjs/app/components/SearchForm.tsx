...
export default function SearchForm({ onSearch, className = '' }: SearchFormProps) {
  ...
  return (
    <div className={`w-full max-w-6xl bg-white rounded-lg shadow-xl px-4 py-2 ${className}`}> {/* Changed max-w-4xl to max-w-6xl */}
      <form onSubmit={handleSearch}>
        {/* Top section with search bars and button */}
        <div className="flex flex-wrap items-center gap-4 mb-4">
          {/* Keywords Input */}
          <div className="flex-1 relative flex items-center"> {/* Changed flex-1 to flex-[2] to make it wider */}
